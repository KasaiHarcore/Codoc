...
class Local(RawTask):
    """
    Encapsulate everything required to run on a local codebase on the disk.
    """

    def __init__(self, task_id: str, local_repo: str):
        self._task_id = task_id
        self.local_repo = local_repo
        self.commit_hash = self.init_local_repo()
        self.readme = app_utils.read_readme_file(self.local_repo)
