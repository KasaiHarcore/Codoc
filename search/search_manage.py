...
class SearchManager:
    ...
    # not search API - for writing documents
    ...
    def extract_fullcode(self, file_path: str) -> tuple[str, str, bool]:
        """
        Extracts and returns the full content of the file at the given path if it is valid.
        ...
        Returns:
            tuple[str, str, bool]: 
                ...
                - A summary message (e.g., "File content extracted successfully").
